                    ...
                    <div class="lg:col-span-1">
                        <div class="sticky top-6">
                            <form action="{{ route('news.index') }}" method="GET"
                                  class="p-4 space-y-4 bg-white border-2 border-gray-300 rounded-lg shadow-sm sm:p-6 sm:space-y-6">
                                <div class="space-y-2">
                                ...
                                <div class="group animate-fade-in" style="animation-delay: {{ $loop->index * 0.1 }}s">
                                    <div
                                        ...
                                        <a href="{{ route('news.show', $article->slug) }}"
                                           class="relative block overflow-hidden aspect-w-3 aspect-h-2 group"> {{-- Changed aspect ratio --}}
                                            @if($article->image)
                                          ...
                                          <div class="p-6">
                                            <h2
                                                class="mb-1 text-lg font-bold text-gray-900 transition-colors duration-300 line-clamp-2 group-hover:text-blue-600"> {{-- Reduced line-clamp --}}
                                                <a href="{{ route('news.show', $article->slug) }}">
                                                    {{ $article->title }}
                                                </a>
                                            </h2>

                                            <div class="mb-2 prose-sm prose text-gray-600 line-clamp-3">  {{-- Reduced line-clamp and margin --}}
