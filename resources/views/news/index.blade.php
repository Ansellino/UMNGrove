<x-app-layout>
                            ...
                            <div class="group animate-fade-in" style="animation-delay: {{ $loop->index * 0.1 }}s">
                                <div
                                    ...
                                    <a href="{{ route('news.show', $article->slug) }}"
                                        class="relative block overflow-hidden aspect-w-16 aspect-h-9 group">
                                        @if($article->image)
                                    ...
                                    <div class="p-6">
                                        <h2
                                            ...
                                            <a href="{{ route('news.show', $article->slug) }}" class="line-clamp-2">
                                                {{ $article->title }}
                                            </a>
                                        </h2>
    ...
    <script>
        function toggleFilters() {
            ...
            filterButtonText.textContent = filterForm.classList.contains('hidden') ? 'Show Filters' : 'Hide Filters';
        }
    </script>
