    ...
    <main class="relative z-10 w-full max-w-lg p-8 border shadow-lg bg-white/10 backdrop-blur-md rounded-3xl border-white/20">
        <div class="flex flex-col items-center">
            <figure class="mb-6">
                ...
                <figcaption class="sr-only">404 Error Icon</figcaption>
            </figure>

            <h1 class="mb-2 text-6xl font-bold text-white font-lora">404</h1>
            <h2 class="mb-1 text-2xl font-semibold text-white/90">Page Not Found</h2>
            <p class="mb-6 text-center text-white/70">Sorry, the page you're looking for doesn't exist or has been moved.</p>
