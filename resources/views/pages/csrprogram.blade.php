                ...
                <div class="overflow-hidden transition-all duration-300 transform bg-white shadow-2xl rounded-3xl hover:shadow-3xl">
                    ...
                    <div class="px-4 mt-8 space-y-24 sm:px-6 lg:px-8">
                        ...
                        <div class="max-w-4xl mx-auto">
                            <div class="p-6 sm:p-8 lg:p-10 bg-green-50 rounded-xl">
                                <h2 class="mb-8 text-2xl font-semibold text-center text-green-800 sm:text-3xl lg:text-4xl">
                                    Open to All CSR Initiatives
                                </h2>
                                <div class="space-y-6">
                                    <p class="text-base text-justify text-gray-700 sm:text-lg">
                                    ...
                                    <p class="text-base font-medium text-gray-700 sm:text-lg">
                        ...
                        <div class="grid grid-cols-1 gap-8 px-4 mt-8 sm:grid-cols-2 lg:grid-cols-4 sm:px-6 lg:px-8">
                            ...
                            <div class="flex flex-col items-center p-6 text-center transition-all duration-300 bg-white border-2 border-gray-200 shadow-lg sm:p-8 rounded-xl hover:shadow-xl">
                                <svg class="w-12 h-12 mb-4 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                                </svg>
                                <h3 class="mb-3 text-lg font-semibold sm:text-xl">Community Empowerment</h3>
                                <p class="text-sm text-gray-600 sm:text-base">Skills training, local business funding, and mangrove-based product development.</p>
                            </div>
                            ...
                            <div class="flex flex-col items-center p-6 text-center transition-all duration-300 bg-white border-2 border-gray-200 shadow-lg sm:p-8 rounded-xl hover:shadow-xl">
                                ...
                                <h3 class="mb-3 text-lg font-semibold sm:text-xl">Environmental Education</h3>
                                <p class="text-sm text-gray-600 sm:text-base">Educational programs for children and communities to raise awareness of ecosystem conservation.</p>
                            </div>
                            ...
                            <div class="flex flex-col items-center p-6 text-center transition-all duration-300 bg-white border-2 border-gray-200 shadow-lg sm:p-8 rounded-xl hover:shadow-xl">
                                ...
                                <h3 class="mb-3 text-lg font-semibold sm:text-xl">Village Infrastructure</h3>
