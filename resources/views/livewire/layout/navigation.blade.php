        ...
        <div class="flex items-center justify-between h-16 sm:h-20">
            ...
            <div class="flex items-center flex-shrink-0">
                <a href="/" class="flex items-center transition-transform duration-300 hover:scale-105">
                    <x-application-logo class="w-auto h-16 sm:h-20" />
                </a>
            </div>

            <!-- Desktop Navigation - Improved -->
            <div class="flex-1 hidden px-8 lg:flex lg:items-center lg:justify-center">
                <div class="flex items-center justify-center space-x-8">
                    @foreach([
                        ...
                        <x-nav-link
                            ...
                            wire:navigate
                            class="relative px-3 py-2 transition-all duration-200 hover:text-blue-600">
            ...
            <div class="items-center hidden space-x-4 lg:flex">
                @auth
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="flex items-center px-3 py-2 transition-all duration-200 rounded-lg hover:bg-gray-50">
                                <!-- Avatar Placeholder -->
                                <div class="flex items-center justify-center w-8 h-8 mr-2 text-white bg-blue-600 rounded-full">
                ...
                @else
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="{{ route('register') }}"
                           class="inline-flex items-center px-4 py-2 text-sm font-medium text-white transition-all duration-200 bg-blue-600 rounded-lg shadow-sm hover:bg-blue-700 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                            Register
                        </a>
                    </div>
                @endauth
