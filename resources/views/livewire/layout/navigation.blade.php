...
<nav x-data="{ open: false }"
     class="sticky top-0 z-50 py-4 border-b border-gray-200 shadow-sm bg-white/95 backdrop-blur-lg dark:bg-gray-800/95 dark:border-gray-700">
            ...
            <div class="hidden w-full mx-4 lg:flex lg:items-center lg:justify-center">
                ...
                <div class="flex items-center gap-4 ml-4 mr-3 space-x-6 lg:absolute lg:left-1/2 lg:-translate-x-1/2">
                    <x-nav-link :href="route('aboutus')" :active="request()->routeIs('aboutus')" wire:navigate>
                        <span class="text-sm font-medium text-black">{{ __('About') }}</span>
                    </x-nav-link>
