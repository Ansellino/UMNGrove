                            ...
                            <div class="max-w-lg mx-auto">
                                ...
                                <div class="mb-6">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span class="px-4 py-1.5 text-sm font-black text-gray-900 bg-green-400 rounded-full shadow-sm uppercase whitespace-nowrap">
                                ...
                                <div class="flex flex-col mb-8 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
                                    ...
                                    <button
                                        ...
                                        class="inline-flex items-center justify-center px-4 py-3 font-medium transition-colors duration-200 bg-gray-100 border border-gray-300 rounded-xl hover:bg-gray-200 {{ $isFavorite ? 'text-red-600' : 'text-gray-700' }}">
                                        <svg wire:loading.class="hidden" class="w-5 h-5 mr-2" fill="{{ $isFavorite ? 'currentColor' : 'none' }}" stroke="currentColor" viewBox="0 0 24 24">
